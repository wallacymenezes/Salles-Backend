package com.projects.sallesregister.controllers.exceptions;
...
import com.projects.sallesregister.services.exceptions.EmailException;
...
public class ControllerExceptionHandler {
	...
	public ResponseEntity<StandardError> emailExcpetion(EmailException e, HttpServletRequest request){
		HttpStatus status = HttpStatus.BAD_REQUEST;
		StandardError err = new StandardError();
		err.setTimestamp(Instant.now());
		err.setStatus(status.value());
